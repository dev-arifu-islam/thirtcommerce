				...
				<?php if ($product != false) { ?>
					<div class="col-md-12">
						...
						<div class="product-info">
							<div id="e-change-product-color" class="form-group product-fields" <?php if(try_to_count($product->design->color_hex) < 2) echo 'style="display: none;"'; ?>>
								<a id="e-button-product-color-mobile" class="btn btn-default btn-xs" <?php if(try_to_count($product->design->color_hex) < 7) echo 'style="display: none;"'; ?> role="button" data-toggle="collapse" aria-expanded="false" href="#product-list-colors" aria-expanded="false" aria-controls="product-list-colors"><span class="pull-left"><?php echo lang('designer_right_choose_product_color'); ?></span><span class="pull-left ui-accordion-header-icon ui-icon ui-icon-triangle-1-s"></span></a>
								<label id="e-label-product-color-mobile" for="fields" <?php if(try_to_count($product->design->color_hex) > 6) echo 'style="display: none;"'; ?>><?php echo lang('designer_right_choose_product_color'); ?></label>
								<div class="product-list-colors-mobile collapse<?php if(try_to_count($product->design->color_hex) < 7) echo ' in'; ?>" id="product-list-colors">
