								...
								<div class="tabs-content-right col-md-9">
									<div id="tabs-1">
										...
										<div class="form-group" id="prices-quantity">
											...
											if(isset($product->prices) && isset($product->prices->price)) {
												...
												for($i=0; $i < try_to_count($price_min); $i++) {
											?>
											<div class="row-prices">
									...
									<div id="tabs-3">
										<div class="customfields">
											<?php 
											if (isset($product->attributes) && try_to_count($product->attributes) > 0 && isset($product->attributes->name)) {
											...
											?>
											<?php for($i=0; $i<try_to_count($a_names); $i++) { ?>
												...
												<div class="panel-body">
													...
													<div class="col-md-8">
														<div class="attrbutes-fields">
															...
															<?php if (isset($o_titles[$i]) && try_to_count($o_titles[$i]) > 0){
																for($j=0; $j<try_to_count($o_titles[$i]); $j++) { ?>
