							...
							<div class="modal-body">
								...
								<div class="row">
									<div class="col-md-3">
										...
										<div class="form-group">
											<label><?php lang('fonts_edit_find_font'); ?> <strong id="fonts-counts"><?php if(isset($google['latin'])) echo try_to_count($google['latin']); else echo 0; ?></strong> <?php lang('fonts_edit_font_show'); ?></label>
