...
class Instagram {
  ...
  public function getLoginUrl($scope = array('basic')) {
    if (is_array($scope) && try_to_count(array_intersect($scope, $this->_scopes)) === try_to_count($scope)) {
  ...
  protected function _makeCall($function, $auth = false, $params = null, $method = 'GET') {
    ...
    if ('POST' === $method) {
      curl_setopt($ch, CURLOPT_POST, try_to_count($params));
  ...
  private function _makeOAuthCall($apiData) {
    ...
    curl_setopt($ch, CURLOPT_POST, try_to_count($apiData));
