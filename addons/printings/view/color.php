...
<div id='price-type-color-tab' class='price-type-tab <?php if ($price_type != 'color') echo 'hidden' ?>'>
	<div class='form-group'>
		...
		<select onchange='printings_change_number_color(this)' class='form-control' style="width: 300px;">
			<?php
				for ( $i = 1, $c = try_to_count($fronts['prices'][0]); $i < 11; $i++ )
				{
				...
				<div class="table-responsive">
					<table class='table table-bordered'>
						<thead>
							...
							<?php $fcolumn = 1;
							for ( $i = 1, $c = try_to_count($fronts['prices'][0]); $i <= $c; $i++ ) : ?>
						...
						<tbody>
							<?php for ( $i = 1, $c = try_to_count( $fronts['prices'] ); $i <= $c; $i++ ) : ?>
							<tr>
				...
				<div class="table-responsive">
					<table class='table table-bordered'>
						<thead>
							<th class='th-first center'><?php echo $addons->lang['addon_printing_table_head_first_color'] ?></th>
							<?php $bcolumn = 1;
							for ( $i = 1, $c = try_to_count( $backs['prices'][0] ); $i <= $c; $i++ ) : ?>
						...
						<tbody>
							<?php for ( $i = 1, $c = try_to_count( $backs['prices'] ); $i <= $c; $i++ ) : ?>
							<tr>
								<td class='td-first center'>
				...
				<div class="table-responsive">
					<table class='table table-bordered'>
						<thead>
							<th class='th-first center'><?php echo $addons->lang['addon_printing_table_head_first_color'] ?></th>
							<?php $lcolumn = 1;
							for ( $i = 1, $c = try_to_count( $lefts['prices'][0] ); $i <= $c; $i++ ) : ?>
						...
						<tbody>
							<?php for ( $i = 1, $c = try_to_count( $lefts['prices'] ); $i <= $c; $i++ ) : ?>
							<tr>
								<td class='td-first center'>
				...
				<div class="table-responsive">
					<table class='table table-bordered'>
						<thead>
							<th class='th-first center'><?php echo $addons->lang['addon_printing_table_head_first_color'] ?></th>
							<?php $rcolumn = 1;
							for ( $i = 1, $c = try_to_count( $rights['prices'][0] ); $i <= $c; $i++ ) : ?>
						...
						<tbody>
							<?php for ( $i = 1, $c = try_to_count( $rights['prices'] ); $i <= $c; $i++ ) : ?>
							<tr>
								<td class='td-first center'>
